...
Requests for new features should first be discussed on the [NodeBB forum](https://community.nodebb.org).
...
security vulnerabilities should be reported privately to security@nodebb.org.
...
- [ ] I have read the [CONTRIBUTING](https://github.com/psychobunny/passport-dapp-web3/blob/master/CONTRIBUTING.md) guidelines.
