...
please post a question on NodeBB's [community forum](https://community.nodebb.org)
rather than filing an issue, but honestly, I may not have the free time to help you.

#### Is this a security issue?

Do not open issues that might have security implications.  Potential security
vulnerabilities should be reported privately to security@nodebb.org.  Once any
...
* passport-dapp-web3 version: <!-- $ npm list passport-dapp-web3 -->
